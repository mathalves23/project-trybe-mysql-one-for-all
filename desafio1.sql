...
CREATE TABLE IF NOT EXISTS SpotifyClone.usuario (
  ...
  data_assinatura VARCHAR(25) NOT NULL
) ENGINE = InnoDB;
...
INSERT INTO SpotifyClone.album (album_id, nome_album, artista_id, ano_lancamento)
VALUES
  (1, 'Envious', 1, 1990),
  (2, 'Exuberant', 1, 1993),
...
INSERT INTO SpotifyClone.musica (musica_id, musica, duracao_segundos, album_id)
VALUES
  (1, 'Soul For Us', 200, 1),
